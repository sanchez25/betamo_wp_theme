...
function my_scripts(){
	...
	wp_enqueue_script( 'slick', get_template_directory_uri() . '/js/slick/slick.min.js', array(), true, true );
	wp_enqueue_script( 'date', get_template_directory_uri() . '/js/date.js', array(), true, true );
	wp_enqueue_script( 'clock', get_template_directory_uri() . '/js/clock.js', array(), true, true );
}
